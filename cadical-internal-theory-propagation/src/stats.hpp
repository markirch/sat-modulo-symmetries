...
struct Stats {
  ...
  struct {
    int64_t triggered;  // number of times external_prop was called
    int64_t lemmas;     // overall number of learned external lemmas
    int64_t propagated; // number of learning and propagating lemmas
    int64_t conflicting; // number of learning and conflicting lemmas
    int64_t final_check;// number of checking found solutions
  } ext_prop;
